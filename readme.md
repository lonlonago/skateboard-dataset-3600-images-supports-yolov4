# Skateboard dataset 3600 images supports YOLOv4

# Body

Skateboard dataset (3600 images), in YOLO format, with clear images and complete annotations, suitable for skateboard object detection, image segmentation, algorithm performance improvement, etc., ready to use directly, saving time and effort.
